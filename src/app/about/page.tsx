          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Tims Tittus</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Tims, a full-stack developer with a strong passion
              for cybersecurity and artificial intelligence, focused on creating meaningful
              digital experiences. With a solid foundation in web development,
              I thrive on turning ideas into reality through thoughtful coding,
              intelligent systems, and clean design. My journey began with a deep
              fascination for technology and a drive to make a positive impact through secure, innovative, and
