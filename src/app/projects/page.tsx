...
export default function ProjectsPage() {
  return (
    <main
      id="main-content"
      className="container mx-auto px-4 md:px-[50px] xl:px-[150px] text-zinc-300 pt-28 pb-24"
    >
      ...
      <ul className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        {PROJECT_META.map((project) => (
          <li
            key={project.slug}
            className="group flex flex-col rounded-xl border-[.5px] border-zinc-600 overflow-hidden"
          ...
          >
            <Link href={projectPath(project)} className="flex h-full flex-col">
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <span className="mt-5 inline-flex items-center gap-1 text-sm text-zinc-300 group-hover:text-white">
